...
public class ColaPendientes extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ColaPendientes
     */
    ...
    private void initComponents() {
        ...
        jButton1.setText("Asignar seleccionado");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText("Cola de tickets");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColaPendientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColaPendientes().setVisible(true);
            }
        });
    }
